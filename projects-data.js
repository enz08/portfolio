...
const PROJECTS = [
  {
    ...
    status: "Terminé",
    summary:
      "Un site d'astronomie avec calendrier des événements célestes, actualités spatiales quotidiennes et newsletter — pensé pour rester simple à faire vivre au fil du temps. Mis à jour chaque jour.",
  ...
  },
  {
    ...
    status: "Terminé",
    summary:
      "Un bot Discord communautaire complet : niveaux, économie, mise en relation entre membres, gestion d'événements et modération. M'ajouter sur Discord pour pouvoir le télécharger gratuitement !",
